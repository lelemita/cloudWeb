...
$(document).ready(function(){
	...
	function save() {
		...
		var fileName = window.prompt("저장할 파일 이름을 적어주세요" , "EventLog");
		...
		$("#sfrm").attr("action","../EventLog/EventSave.hs");
		$("#sfrm").submit();
	}	
	...
	function print() {
		...
		$("#sfrm").attr("action","../EventLog/EventPrint.hs");
		$("#sfrm").submit();
		// 원래 값으로 복구
		$("#sfrm").attr("target","_self");
		$("#sfrm").attr("action","../EventLog/EventList.hs")	
...
<body> 
	...
	<div class="container" >
		...
		<form method="post" id="sfrm" action="../EventLog/EventList.hs">
			...
			<c:if test="${LIST ne null && LIST.size() ne 0}">
